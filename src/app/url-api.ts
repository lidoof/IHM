export const URL ={
  ...
  GET_WALLET: '/api/customer/GetCustomerWallet/',
  INSCIRPTION: '',
  UPDATE_CUSTOMET:'/api/customer/UpdateCustomer/',
  RESERVATION:'/api/reservation/create',
  DELETE_WALLET:'/api/customer/DeleteCustomer/',
  CONFIRMER_RESERVATION:'/api/reservation/confirm/',
  CANCEl_RESERVATION:'/api/reservation/cancel/',
  SEARCH_ROOM:'/api/room/search'
